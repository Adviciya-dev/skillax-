...
async def seed_data():
    ...
    extra_course = {
        "id": str(uuid.uuid4()),
                ...
                "description": "Learn to create and manage high-converting ad campaigns across Facebook, Instagram, Google, and LinkedIn. Perfect for marketers wanting to specialize in paid media.",
                "duration": "2 Months",
                "modules": [
                    {"title": "Social Media Strategy", "topics": ["Platform Selection", "Content Calendar", "Community Management"]},
                    {"title": "Facebook & Instagram Ads", "topics": ["Ad Manager", "Audience Targeting", "Creative Best Practices"]},
                    {"title": "Google Ads", "topics": ["Search Ads", "Display Network", "YouTube Ads"]},
                    {"title": "LinkedIn Marketing", "topics": ["B2B Strategies", "LinkedIn Ads", "Lead Generation"]},
                    {"title": "Campaign Optimization", "topics": ["A/B Testing", "Budget Management", "ROI Tracking"]}
                ],
            ...
            },
            {
                ...
                "description": "Learn to use ChatGPT, Midjourney, and other AI tools to automate and enhance your digital marketing efforts. Stay ahead of the curve with cutting-edge AI marketing.",
                "duration": "1 Month",
                "modules": [
                    {"title": "AI Fundamentals for Marketers", "topics": ["Understanding AI", "AI in Marketing", "Prompt Engineering"]},
                    {"title": "Content Creation with AI", "topics": ["ChatGPT Mastery", "AI Copywriting", "AI Image Generation"]},
                    {"title": "AI Marketing Automation", "topics": ["Workflow Automation", "AI Email Marketing", "Predictive Analytics"]},
                    {"title": "AI Tools Workshop", "topics": ["Jasper AI", "Copy.ai", "Canva AI", "Buffer AI"]}
                ],
            ...
            },
            {
                ...
                "description": "Specialized course covering marketing strategies for websites and mobile apps. Learn app store optimization, growth hacking, and technical marketing skills.",
                "duration": "2 Months",
                "modules": [
                    {"title": "Web Marketing", "topics": ["CRO Fundamentals", "Heatmaps & Analytics", "A/B Testing"]},
                    {"title": "App Store Optimization", "topics": ["ASO Strategies", "App Store Rankings", "App Analytics"]},
                    {"title": "Growth Hacking", "topics": ["Growth Frameworks", "Viral Loops", "Referral Programs"]},
                    {"title": "Marketing Technology", "topics": ["MarTech Stack", "CRM Integration", "Marketing Automation"]},
                    {"title": "QA for Marketing", "topics": ["Campaign Testing", "Tracking Implementation", "Data Quality"]}
                ],
            ...
            },
            {
                ...
                "description": "Learn how to build a successful freelancing career or start your own digital marketing agency. Covers client acquisition, pricing, and business operations.",
                "duration": "1 Month",
                "modules": [
                    {"title": "Freelancing Fundamentals", "topics": ["Platform Setup", "Profile Optimization", "Pricing Strategies"]},
                    {"title": "Client Acquisition", "topics": ["Lead Generation", "Proposal Writing", "Networking"]},
                    {"title": "Agency Operations", "topics": ["Team Building", "Project Management", "Client Management"]},
                    {"title": "Business Development", "topics": ["Legal Setup", "Contracts", "Scaling Strategies"]}
                ],
                ...
                "price": "Contact for pricing",
                "featured_image": "https://images.unsplash.com/photo-1553484771-371a605b060b?w=800",
                "active": True,
                "created_at": datetime.now(timezone.utc).isoformat()
            }
        ]
