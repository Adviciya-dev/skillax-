...
import { 
  Briefcase, TrendingUp, DollarSign, MapPin, Building,
  GraduationCap, Award, CheckCircle, ArrowRight, Sparkles,
  Users, Globe, Clock, Star, Rocket, Target, Upload,
  Linkedin, FileText
} from 'lucide-react';
...
const careerPaths = [
  {
    ...
    skills: ['Strategy', 'Team Management', 'Budget Optimization', 'Analytics'],
  ...
  },
  {
    ...
    skills: ['Technical SEO', 'Content Strategy', 'Link Building', 'AEO/GEO'],
  ...
  },
  {
    ...
    skills: ['Content Creation', 'Community Management', 'Paid Ads', 'Analytics'],
  ...
  },
  {
    ...
    skills: ['Writing', 'SEO', 'Video', 'Distribution'],
    companies: ['Publishers', 'SaaS', 'Agencies', 'Brands'],
  },
  {
    ...
    skills: ['Multiple Skills', 'Client Management', 'Self-Marketing'],
...
const placementPartners = [
  ...
  { name: 'Freelance Platforms', type: 'Global Work' },
];

// Success Stories
const successStories = [
  { name: 'Rahul K.', role: 'Digital Marketer @ Infopark', salary: '₹45,000/month', batch: '2023' },
  { name: 'Priya M.', role: 'Freelancer', salary: '₹80,000/month', batch: '2023' },
  { name: 'Arun S.', role: 'SEO Lead @ Agency', salary: '₹55,000/month', batch: '2024' },
  { name: 'Sneha R.', role: 'Social Media Manager', salary: '₹40,000/month', batch: '2024' },
];
...
// Resume Upload Modal
function ResumeUploadModal({ isOpen, onClose }) {
        ...
        {isSuccess ? (
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground mb-6">
              We've received your details. Our career counselor will review your profile 
          ...
          <>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Get personalized career guidance</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5">Current Experience</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5">Tell us about your career goals</label>
                <textarea
              ...
              >
                {isSubmitting ? 'Submitting...' : 'Get Free Career Assessment'}
              </Button>
            </form>
          </>
        )}
...
export default function Careers() {
  ...
  return (
    <div className="overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-white">
          <AnimatedSection className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-white/80 mb-8">
              With Infopark internship, 25+ certifications, and dedicated placement support, 
              your dream career is within reach. Starting salary: ₹40,000-80,000/month!
            </p>
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { label: 'Entry Level', salary: '₹3-5 LPA', icon: GraduationCap, color: 'from-blue-500 to-cyan-500' },
              { label: '2-3 Years Exp', salary: '₹5-8 LPA', icon: TrendingUp, color: 'from-green-500 to-emerald-500' },
              { label: 'Senior Level', salary: '₹8-15 LPA', icon: Star, color: 'from-purple-500 to-pink-500' },
              { label: 'Freelancing', salary: '₹10-30+ LPA', icon: Globe, color: 'from-orange-500 to-red-500' },
            ].map((item, i) => {
              ...
              return (
                <AnimatedSection key={i} delay={i * 0.1}>
                  ...
                  >
                    ...
                    <h3 className="font-heading font-bold text-2xl text-primary mb-1">{item.salary}</h3>
        ...
        <div className="container-custom">
          <AnimatedSection className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Digital marketing offers diverse career paths. Find what suits you best.
            </p>
          </AnimatedSection>
              ...
              return (
                <AnimatedSection key={index} delay={index * 0.1}>
                  ...
                  >
                    ...
                    <p className="text-primary font-semibold mb-4">{path.salary}</p>
            ...
            {successStories.map((story, i) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                ...
                >
                  ...
                  <p className="text-brand-success font-bold">{story.salary}</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection delay={0.2}>
              <div className="card-base bg-gradient-to-br from-primary/10 to-brand-amber/10 border-primary/20">
                <h3 className="font-heading font-bold text-xl mb-6 text-center">Placement Partners</h3>
                <div className="grid grid-cols-2 gap-4">
        ...
        <div className="container-custom text-center">
          <AnimatedSection>
            ...
            <p className="text-white/80 max-w-2xl mx-auto mb-8">
              Join Skillax Academy and transform your career with in-demand digital skills, 
      ...
      {/* Resume Upload Modal */}
      <ResumeUploadModal isOpen={showResumeModal} onClose={() => setShowResumeModal(false)} />
    </div>
  );
}
